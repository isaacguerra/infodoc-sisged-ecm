        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="general_info">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="CFG_APP_NAME"><span class="required-label">*</span><?php echo TEXT_APPLICATION_NAME ?></label>
                    <div class="col-md-9">	
                        <?php echo input_tag('CFG[APP_NAME]', CFG_APP_NAME, array('class' => 'form-control input-xlarge required')); ?>
                    </div>			
                </div>
                
                <div class="form-group">
                    <label class="col-md-3 control-label" for="CFG_APP_NAME"><?php echo TEXT_NAME_ON_MOBILE_DEVICE ?></label>
                    <div class="col-md-9">	
                        <?php echo input_tag('CFG[APP_SHORT_NAME_MOBILE]', CFG_APP_SHORT_NAME_MOBILE, array('class' => 'form-control  input-large')); ?>
                    </div>			
                </div>

                <div class="form-group">
                    <label class="col-md-3 control-label" for="CFG_APP_SHORT_NAME"><span class="required-label">*</span><?php echo TEXT_APPLICATION_SHORT_NAME ?></label>
                    <div class="col-md-9">	                           
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">	
                        <?php echo input_tag('CFG[APP_COPYRIGHT_NAME]', CFG_APP_COPYRIGHT_NAME, array('class' => 'form-control input-xlarge')); ?>
                        <span class="help-block"><?php echo TEXT_COPYRIGHT_NAME_TOOLTIP ?></span>
                        <?= tooltip_text('[year] - ' . TEXT_CURRENT_YEAR) ?>
                    </div>			
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="input-group input-medium">
                            ...
                            <span class="input-group-btn">
                                <a href="https://www.rukovoditel.net<?= (APP_LANGUAGE_SHORT_CODE=='ru' ? '.ru':'') ?>/translations.php" target="_blank" class="btn btn-default" type="button"><?= TEXT_BUTTON_ADD ?></a>
                            </span>
                        </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="CFG_DROP_DOWN_MENU_ON_HOVER"><?php echo TEXT_DROP_DOWN_MENU_ON_HOVER ?></label>
                    <div class="col-md-9">	
                        <?php echo select_tag('CFG[DROP_DOWN_MENU_ON_HOVER]', $default_selector, CFG_DROP_DOWN_MENU_ON_HOVER, array('class' => 'form-control input-small')); ?>
                    </div>			
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="CFG_HIDE_POWERED_BY_TEXT"><?php echo TEXT_HIDE . ' "' . TEXT_POWERED_BY . ' Urbanus"' ?></label>
                    <div class="col-md-9">	
